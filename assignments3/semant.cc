...
SymbolTable<Symbol, Class__class> *ClassTable::install_basic_classes() {
    SymbolTable<Symbol, Class__class> *class_graph =
        new SymbolTable<Symbol, Class__class>();
    ...
    class_graph->addid(Object, Object_class);
    // 
    ...
    class_graph->addid(Int, Int_class);
    //
    ...
    class_graph->addid(Bool, Bool_class);
    //
    ...
    class_graph->addid(Str, Str_class);
